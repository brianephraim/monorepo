...
const Sidebar = ({ onClick, path }) =>
  <div className={styles.sidebar}>
    ...
    <NavLink activeClassName={styles.active} exact to='/migration'>MIGRATION</NavLink>
    <NavLink activeClassName={styles.active} exact to='/battleship'>BATTLESHIP</NavLink>
    ...
    <span className={active(path, '/')} onClick={() => onClick('HOME_UNIVERSAL_DEMO')}>
      HOME_UNIVERSAL_DEMO
    </span>

    <span className={active(path, '/migration')} onClick={() => onClick('MIGRATION')}>
      MIGRATION
    </span>
    <span className={active(path, '/battleship')} onClick={() => onClick('MIGRATION')}>
      BATTLESHIP
    </span>
