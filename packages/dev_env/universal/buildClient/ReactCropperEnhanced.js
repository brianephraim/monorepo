...
var ReactCropper = function (_Component) {
  ...
  _createClass(ReactCropper, [{
    ...
    value: function componentDidMount() {
      ...
      var Cropper = __webpack_require__(1095).default;
...
var _typeof2 = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; /* eslint-disable no-underscore-dangle */
...
var _cropper = __webpack_require__(1095);
...
function _removeClass(element, value) {
  if (!value) {
    return;
  }
...
var ACTION_NORTH_EAST = 'ne';
var ACTION_NORTH_WEST = 'nw';
_cropper2.default.prototype.change = function change(shiftKey, originalEvent) {
  var self = this;
  var options = self.options;
  var cropBoxData = self.cropBoxData;
  var aspectRatio = options.aspectRatio;
  ...
  switch (action) {
    ...
    // Zoom canvas
    case 'zoom':
      self.zoom(function zoomVariableHelper(x1, y1, x2, y2) {
        var z1 = Math.sqrt(x1 * x1 + y1 * y1);
        var z2 = Math.sqrt(x2 * x2 + y2 * y2);
...
_cropper2.default.prototype.limitCropBox = function limitCropBox(sizeLimited, positionLimited) {
  var self = this;
  var options = self.options;
  var aspectRatio = options.aspectRatio;
  var containerData = self.containerData;
...
var _reactCropper = __webpack_require__(1098);

var _reactCropper2 = _interopRequireDefault(_reactCropper);

var _windowSizer = __webpack_require__(169);

var _windowSizer2 = _interopRequireDefault(_windowSizer);

var _vanilla = __webpack_require__(251);

var _vanilla2 = _interopRequireDefault(_vanilla);

var _bind_here = __webpack_require__(252);

var _bind_here2 = _interopRequireDefault(_bind_here);
...
var ReactCropperEnhanced = function (_Component) {
  _inherits(ReactCropperEnhanced, _Component);

  function ReactCropperEnhanced(props) {
    _classCallCheck(this, ReactCropperEnhanced);

    var _this = _possibleConstructorReturn(this, (ReactCropperEnhanced.__proto__ || Object.getPrototypeOf(ReactCropperEnhanced)).call(this));
    ...
    _this.methodsBoundHere = (0, _bind_here2.default)(_this, ['ready', 'crop', 'cropmove', 'cropend']);
    Object.assign(_this, _this.methodsBoundHere);
    return _this;
  }

  _createClass(ReactCropperEnhanced, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;
      ...
      this.removeWindowSizerCb = _windowSizer2.default.addCb(function () {
        _this2.refreshCropper();
      });
    }
  }, {
    key: 'componentWillReceiveProps',
    ...
    key: 'refreshCropper',
    value: function refreshCropper() {
      var _this3 = this;

      this.setState({ cropperExists: false }, function () {
        // setTimeout(() => {
        _this3.setState({ cropperExists: true });
        // },2000);
      });
    }
  }, {
    ...
    value: function ready() {
      ...
      if (this.props.cropSrc && this.cropper && this.cropper.cropper && this.cropper.cropper.cropBox) {
        ...
        _vanilla2.default.prepend(this.cropper.cropper.cropBox, sampleImg);
      ...
      (_props = this.props).ready.apply(_props, arguments);
    }
  }, {
    key: 'crop',
    value: function crop(cropData) {
      ...
      if (!this.unmounted) {
        ...
        (_props2 = this.props).crop.apply(_props2, [cropData].concat(args));
      }
    }
  }, {
    key: 'cropend',
    value: function cropend() {
      var _props3;

      this.setState({ moving: false });
      (_props3 = this.props).cropend.apply(_props3, arguments);
    }
  }, {
    key: 'cropmove',
    value: function cropmove() {
      var _props4;

      this.setState({ moving: true });
      (_props4 = this.props).cropmove.apply(_props4, arguments);
    }
  }, {
    key: 'render',
    value: function render() {
...
//# sourceMappingURL=ReactCropperEnhanced.js.map